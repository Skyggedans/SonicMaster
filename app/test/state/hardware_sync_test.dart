...
void main() {
  ...
  group('01020409 module enable report (on-pedal on/off)', () {
    // Device frames (module 2): 8080F0 <crc><prefix> 01020409 00 <module> 00×7
    // <state> 00×6 F7. CRC/prefix vary and are unchecked; module is at [32:34],
    // state at [48:50] (1 = on).
    test('module toggled ON', () {
      final e =
          classify(
    ...
    test('module toggled OFF', () {
      final e =
          classify(
                '8080F0000020001000000A0102040900020000000000000000000000000000F7',
              )
              as ModuleToggled;
