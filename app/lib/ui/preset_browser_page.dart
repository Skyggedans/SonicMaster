                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                                      ...
                                      if ((names[current] ?? '')
                                        ...
                                        ConstrainedBox(
                                          ...
                                          child: Text(
                                            ...
                                            maxLines: 1,
                                            overflow: .ellipsis,
                                            style: AppText.presetTitle.copyWith(
                              ...
                              if (isDesktopWindow) const SizedBox(width: 8),
                      ...
                      child: LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          final maxHeight = rawMax < minConsoleHeight
                              ? minConsoleHeight
                              : rawMax;
                          final effectiveHeight = consoleHeight.value.clamp(
                            minConsoleHeight,
                            maxHeight,
                          );
                              ...
                              if (kDebugMode && isConsoleOpen.value) ...[
                                ...
                                SizedBox(
                                  ...
                                  child: DevConsolePanel(
                                    onClose: () => isConsoleOpen.value = false,
                                  ),
                                ),
                              ],
                            ],
